...
class DiscussionService {
  ...
  // ⚠️ Replace with your actual backend URL that handles the 'socratic_tutor' mode
  final String _aiBackendUrl =
      'https://agent.topscoreapp.ai/api/chat/group_moderator';
